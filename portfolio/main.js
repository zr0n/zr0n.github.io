...
var CategoriesService = /** @class */ (function () {
    ...
    CategoriesService.prototype.makeJobs = function () {
        ...
        var job0 = new _types__WEBPACK_IMPORTED_MODULE_3__["Job"](this.embedVideoService); // Academigo
        var job1 = new _types__WEBPACK_IMPORTED_MODULE_3__["Job"](this.embedVideoService); // BBlender
        var job2 = new _types__WEBPACK_IMPORTED_MODULE_3__["Job"](this.embedVideoService); // Churroz Game Engine
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(inEmbedVideoService, inCategoriesService, locationService) {
...
var JobDetailComponent = /** @class */ (function () {
    function JobDetailComponent(activatedRoute, embedVideoService, inCategoriesService, inLocation) {
...
var Job = /** @class */ (function () {
    ...
    Job.prototype.setupWithVideo = function (inTitle, inDescription, inCategories, inVideo, inThumbnail) {
    ...
    Job.prototype.setupWithImage = function (inTitle, inDescription, inCategories, inImage, inThumbnail) {
        if (inThumbnail === void 0) { inThumbnail = ""; }
        this.title = inTitle;
    ...
    Job.prototype.setup = function (inDescription, inCategories) {
